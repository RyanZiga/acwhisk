  ...
  const fetchAdminData = async () => {
    try {
      ...
      try {
        ...
        if (
          !recipesError ||
          (recipesError.code !== "PGRST205" &&
            recipesError.code !== "42P01")
        ) {
      ...
      if (
        ...
        setError(
          "Database tables may not be set up yet. Please check the setup instructions.",
        );
      }
    } catch (error) {
      console.error("Error fetching admin data:", error);
      setError(
        "An error occurred while fetching data. Database may need setup.",
      );
    } finally {
      setLoading(false);
    }
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <Alert className="max-w-md">
          ...
          <AlertDescription>
            Admin access required. You don't have permission to
            view this page.
          </AlertDescription>
        </Alert>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Manage users, monitor activities, and maintain
          platform content
        </p>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p>
                  All content moderation tools will be available
                  here
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p>
                  Global settings and configuration options will
                  be available here
                </p>
                <div className="mt-6">
