...
export function LearningHub() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Header */}
      <div className="px-1">
        <h1 className="text-xl sm:text-2xl font-bold">Learning Hub</h1>
        <p className="text-muted-foreground text-sm sm:text-base">Enhance your culinary skills with expert-led courses and resources</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          ...
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="min-w-0">
                <p className="text-lg sm:text-2xl font-bold">{progress.completedLessons}</p>
        ...
        <Card>
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="min-w-0">
                <p className="text-lg sm:text-2xl font-bold">{progress.currentStreak}</p>
        ...
        <Card>
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="min-w-0">
                <p className="text-lg sm:text-2xl font-bold">{progress.totalPoints}</p>
                <p className="text-xs sm:text-sm text-muted-foreground">Learning Points</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-3 sm:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <GraduationCap className="h-6 w-6 sm:h-8 sm:w-8 text-orange-600 flex-shrink-0" />
              <div className="min-w-0">
                <p className="text-lg sm:text-2xl font-bold">{Math.round((progress.completedLessons / progress.totalLessons) * 100)}%</p>
      ...
      <Tabs defaultValue="featured" className="space-y-4 sm:space-y-6">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 h-auto p-1">
          <TabsTrigger value="featured" className="text-xs sm:text-sm p-2">
            <span className="hidden sm:inline">Featured Lessons</span>
            <span className="sm:hidden">Featured</span>
          </TabsTrigger>
          <TabsTrigger value="skills" className="text-xs sm:text-sm p-2">
            <span className="hidden sm:inline">Skill Categories</span>
            <span className="sm:hidden">Skills</span>
          </TabsTrigger>
          <TabsTrigger value="resources" className="text-xs sm:text-sm p-2">Resources</TabsTrigger>
          <TabsTrigger value="progress" className="text-xs sm:text-sm p-2">
        ...
        <TabsContent value="featured" className="space-y-4 sm:space-y-6">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 px-1">Featured Lessons</h2>
        ...
        <TabsContent value="skills" className="space-y-4 sm:space-y-6">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 px-1">Skill Categories</h2>
